package site.praytogether.pray_together.domain.prayer.presentation.dto.request;
...
import site.praytogether.pray_together.domain.prayer.domain.PrayerRequestContent;
...
public class PrayerCreateRequest {
  ...
  private final List<PrayerRequestContent> contents;
}
